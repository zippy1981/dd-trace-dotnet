...
namespace Datadog.Trace.Agent
{
    internal class SpanBuffer
    {
        ...
        private readonly IMessagePackFormatter<ArraySegment<ISpanInternal>> _formatter;
        ...
        public SpanBuffer(int maxBufferSize, IFormatterResolver formatterResolver)
        {
            ...
            _formatter = _formatterResolver.GetFormatter<ArraySegment<ISpanInternal>>();
        }
        ...
        public bool TryWrite(ArraySegment<ISpanInternal> trace, ref byte[] temporaryBuffer)
        {
