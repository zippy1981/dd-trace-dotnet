...
internal enum TraceTagSerializationMode
{
    ...
    /// <summary>
    /// Add the trace tag to the trace's root span only.
    /// </summary>
    RootSpan,
    ...
    /// <summary>
    /// Add the trace tag to spans whose parent is not present in the same trace chunk.
    /// This ensures that at least one span in every trace chunk contains the tag.
    /// </summary>
    ChunkOrphans,
}
