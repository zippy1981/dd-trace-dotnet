...
namespace Datadog.Trace.ClrProfiler
{
    ...
    internal abstract class CommonTracer : ICommonTracer
    {
        ...
        {
            return (int?)Tracer.Instance.InternalActiveScope?.Span.TraceContext.SamplingPriority;
        }

        public void SetSamplingPriority(int? samplingPriority)
        {
            var traceContext = Tracer.Instance.InternalActiveScope?.Span.TraceContext;
