// <copyright file="HaproxyDisconnectFrame.cs" company="Datadog">
...
{
    internal class HaproxyDisconnectFrame : Frame
    {
        public HaproxyDisconnectFrame()
            : base(FrameType.HaproxyDisconnect)
        {
