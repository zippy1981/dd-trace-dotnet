// <copyright file="FrameProcessor.cs" company="Datadog">
...
{
    internal class FrameProcessor : IFrameProcessor
    {
        private const string SupportedSpoeVersion = "2.0";
