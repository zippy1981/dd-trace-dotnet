...
namespace Datadog.Trace.OpenTracing
{
    internal class OpenTracingTracer : global::OpenTracing.ITracer
    {
        ...
        public OpenTracingTracer(ITracer datadogTracer)
            : this(datadogTracer, new global::OpenTracing.Util.AsyncLocalScopeManager())
        {
        }

        public OpenTracingTracer(ITracer datadogTracer, global::OpenTracing.IScopeManager scopeManager)
        {
        ...
        public ITracer DatadogTracer { get; }
        ...
        ISpan global::OpenTracing.ITracer.ActiveSpan => ScopeManager.Active?.Span;
